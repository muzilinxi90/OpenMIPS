...
HD_PWD='C:/Users/LMX/Desktop/MyProject/OpenMIPS/OpenMIPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log openmips_min_sopc.vdi -applog -m64 -messageDb vivado.pb -mode batch -source openmips_min_sopc.tcl -notrace
