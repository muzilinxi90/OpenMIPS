...
set rc [catch {
  ...
  write_bitstream -force openmips_min_sopc.bit -bin_file
  catch { write_sysdef -hwdef openmips_min_sopc.hwdef -bitfile openmips_min_sopc.bit -meminfo openmips_min_sopc.mmi -file openmips_min_sopc.sysdef }
